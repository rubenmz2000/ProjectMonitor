...
Small, maintained set of documents with the context a new person or a new agent session needs.
Keep them short and current; when a decision or a change makes something here obsolete, update it
in the same PR.
...
When they disagree, the code is the fact and the docs need fixing, but the *direction* stays the
one written here unless Rubén changes it.
